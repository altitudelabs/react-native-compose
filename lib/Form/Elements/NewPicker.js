...
class NewPicker extends BaseElement {
  constructor(props) {
    super(props);
    this.state = {
  ...
  validate() {
    console.log('NewPicker performs validation', this.state.value);
  ...
  getSelectedItem() {
    ...
    return selectedItem ? selectedItem : this.getDefaultSelectedItem();
  }
